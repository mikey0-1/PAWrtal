...
class MobilePetsController extends GetxController {
  final AuthRepository authRepository;
  final UserSessionService session;

  MobilePetsController({required this.authRepository, required this.session});
  ...
  // Medical appointments across all clinics
  ...
  /// Debug method for testing vaccination fetching
